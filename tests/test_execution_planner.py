...
class TestDependencyGraph:
    ...
    def test_resolve_dependencies_with_cycle(self):
...
class TestExecutionPlanner:
    """Test ExecutionPlanner functionality."""
    ...
    def test_execution_planner_creation(self):
    ...
    def test_extract_cluster_type(self):
    ...
    def test_create_execution_plan_with_dependencies(self):
        ...
        cluster_config = config.clusters["worker"]
    ...
    def test_enhance_service_config(self):
