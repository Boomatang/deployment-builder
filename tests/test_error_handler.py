...
class TestErrorHandler:
    ...
    def test_retry_failed_service(self):
...
class TestRecoveryManager:
    ...
    def test_recovery_manager_creation(self):
        ...
        queue, error_handler, recovery_manager = self.create_test_setup()
    ...
    def test_add_recovery_operation(self):
    ...
    def test_start_stop_recovery_monitoring(self):
    ...
    def test_attempt_recoveries(self):
...
class TestGlobalInstances:
    """Test global error handling instances."""
...
class TestIntegration:
    ...
    def test_error_escalation_with_callbacks(self):
