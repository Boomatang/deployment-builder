...
class TestServiceItem:
    """Test ServiceItem data structure."""
    ...
    def test_service_item_creation_time_comparison(self):
...
class TestServiceQueue:
    ...
    def test_add_service_item(self):
...
class TestServiceWorker:
    """Test ServiceWorker functionality."""
    ...
    def test_execute_service_success(self, mock_run):
    ...
    @patch("subprocess.run")
    def test_execute_service_timeout(self, mock_run):
